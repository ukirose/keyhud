...
修飾キーを押している間だけ、そのアプリで実際に効くショートカットが出るものです。呼び出す操作は要りません。

あわせて、どれが身についたかを記録します。パネルを見てから打ったか、見ずに打ったかを区別して数え、後者だけが進みます。

## なぜか

はじめは「このアプリの ⌘K って何だっけ」を調べるのが面倒で、チートシート系のツールを入れていました。ただ、呼び出すこと自体を忘れます。

作る前に自分の使用状況を測ったところ、想定と違う数字が出ました。手元の Finder でキーボードから到達できるショートカットは 108 個、全アプリでは 728 個。そのうち実際に使っているのは 24 個（3.3%）で、しかも上位5個が全使用の 80% を占めていました。

つまり本当の問題は「知っているものを速く引く」ことではありませんでした。97% を知らないままで、そして知らないものは調べに行くこともできない、ということでした。

そこで、呼び出す形式をやめました。修飾キーを押しているのは、どうせショートカットを打とうとしている瞬間です。そこに出せば、打とうとしていた1個のついでに、その組み合わせで効く残り全部が目に入ります。すでに毎日何十回も行っている動作に相乗りする形です。

学習の記録を足したのは、この「ついでに目に入る」が効いているかどうかが、記録しないと分からないからです。見ずに打てたものは身についた、見てから打ったものはまだ、と区別できれば、パネルはまだの方に注意を割けます。

一つ、方針として決めたことがあります。身についたものを隠したり、覚えるまで見せないようにしたりはしません。補助ツールが情報を出し惜しみした時点で、第一の機能が壊れるからです。身についたものは薄く表示されるだけで、いつでも読めます。
